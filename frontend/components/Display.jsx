    ...
    <div className="w-full max-w-[500px] h-[280px] sm:h-[300px] bg-[#142823] rounded-2xl shadow-[0_4px_20px_rgba(37,188,124,0.2)] p-4 sm:p-5 flex flex-col gap-4 text-[#25BC7C] font-sans">
      ...
      <div className="text-sm text-[#A0D8C2]">
        {message
          ...
          : "Upload a file to verify its hash integrity"}
      </div>
      <div className="flex-1 bg-[#1a372e] border border-dashed border-[#25bc7c44] rounded-xl p-3 font-mono text-xs sm:text-sm text-[#defbe6] overflow-auto custom-scroll text-center">
